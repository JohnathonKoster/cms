...
/**
 * A source token whose internals are deliberately not interpreted as HTML.
 *
 * Comments, declarations, processing instructions, and ignored/bogus tags
 * live here. Antlers regions inside the token still receive a stable local
 * parent and sibling list without allowing DOM-style child mutation that
 * could make the surrounding syntax invalid.
 */
